...
class AdoptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adoption" do
    assert_difference('Adoption.count') do
      post adoptions_url, params: { adoption: { cat_id: @adoption.cat_id, notes: @adoption.notes, owner_id: @adoption.owner_id } }
    end
  ...
  test "should update adoption" do
    patch adoption_url(@adoption), params: { adoption: { cat_id: @adoption.cat_id, notes: @adoption.notes, owner_id: @adoption.owner_id } }
