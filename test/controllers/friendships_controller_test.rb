...
class FriendshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friendship" do
    assert_difference('Friendship.count') do
      post friendships_url, params: { friendship: { dest_cat_id: @friendship.dest_cat_id, notes: @friendship.notes, src_cat_id: @friendship.src_cat_id } }
    end
  ...
  test "should update friendship" do
    patch friendship_url(@friendship), params: { friendship: { dest_cat_id: @friendship.dest_cat_id, notes: @friendship.notes, src_cat_id: @friendship.src_cat_id } }
